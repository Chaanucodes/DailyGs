...
class CustomExpandableListAdapter(
    ...
    override fun getChildView(
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(com.chan.dailygoals.R.layout.list_item, null)
        }
        val expandedListTextView = convertView!!
            .findViewById(com.chan.dailygoals.R.id.expandedListItem) as TextView
    ...
    override fun getGroupView(
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(com.chan.dailygoals.R.layout.list_group, null)
        }
        val listTitleTextView = convertView!!.findViewById(com.chan.dailygoals.R.id.listTitle) as TextView
